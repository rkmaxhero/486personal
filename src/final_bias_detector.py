...
if len(sys.argv) < 2:
    print("Usage: python final_bias_detector.py \"Your sentence with biased language.\"")
    sys.exit(1)
...
# Critical: Create a symlink from lexicons to src/lexicons so the features module can find the lexicon files
# This avoids having to modify the features.py code
